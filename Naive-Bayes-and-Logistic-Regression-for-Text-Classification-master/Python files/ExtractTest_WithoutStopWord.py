...
****** DO Extract ETst but now with stop word **********8888
'''
import os
...
def test_stop1(stop_word, stop_wordlist, test_ham_folder, test_spam_folder):
    ...
    row_count, position = getarrayintorequired_negaive(spam_array, 0, stop_word)
    getarrayintorequired_positive(ham_array, row_count, position, stop_word)
    weightvector, inputvector = formrealattributes(stop_wordlist)
