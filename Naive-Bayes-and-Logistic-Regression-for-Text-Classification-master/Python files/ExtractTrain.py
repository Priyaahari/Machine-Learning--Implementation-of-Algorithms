...
def Getfilesinfolder(path):
    ...
    for dir_entry in os.listdir(path):
        ...
        #print('dir_entry_path', dir_entry_path)
        if os.path.isfile(dir_entry_path):
        #appends the path of all files  in that folder in a list
...
def getfilesintoarray(list):
    data = []
    for files in list:
    #now open each files in that list , read it and put the contents in the array
    ...
    for each_data in list:
        ...
        for words in words_inlist:
            ...
            #finds the index and increments the repsective counts
                ...
                '''Wordlist consists of all words and wordcunt has count of all words present. '''
